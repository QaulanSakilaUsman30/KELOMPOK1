          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2><i class="fa fa-users"></i>&nbsp;DATA BAGIAN</h2>
                    <div class="clearfix"></div>
                  </div>
                  <a href="inputbagian.php"><button type="button" class="btn btn-primary btn-lg"><i class="fa fa-plus"></i> Tambah Bagian</button></a>
                  <div class="x_content">
                  <div class="x_content">
                             <?php
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                            ...
                            while($data = mysqli_fetch_array($query1)){
                              ...
                              <a href=detail-bagian.php?id_bagian='.$data['id_bagian'].'><button type="button" title="Detail" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></button></a>
