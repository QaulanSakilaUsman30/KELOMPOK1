          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2><i class="fa  fa-inbox"></i>&nbsp;TAMBAH SURAT MASUK</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form action="proses/proses_inputsuratmasuk.php"  name="formsuratmasuk" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <?php 
                        ...
                        if ($jumlah == 0) { // Use '==' for comparison
                            $nomorbaru = "0001"; // If no records found, start with "0001"
                        } else {
                            $nomor = $data['nomorurut_suratmasuk']; // Access the last nomor
                            $nomormax = substr($nomor, 0, 4); // Get the numeric part
                            $nomorbaru = str_pad(intval($nomormax) + 1, 4, "0", STR_PAD_LEFT); // Increment and pad with zeros
                        }
