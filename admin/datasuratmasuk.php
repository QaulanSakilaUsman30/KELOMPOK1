            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <a href="inputsuratmasuk.php"><button type="button" class="btn btn-primary btn-lg"><i class="fa fa-plus"></i> Tambah Surat Masuk</button></a>
                  </form>
                  <div class="x_content">
                  <div class="x_content">
                              <?php
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                            ...
                            while($data = mysqli_fetch_array($query1)){
                              ...
                              <a href=detail-suratmasuk.php?id_suratmasuk='.$data['id_suratmasuk'].'><button type="button" title="Detail" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></button></a>
