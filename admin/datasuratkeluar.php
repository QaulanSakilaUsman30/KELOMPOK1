          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2><i class="fa  fa-send"></i>&nbsp;DATA SURAT KELUAR</h2>
                    <div class="clearfix"></div>
                  </div>
                  <a href="inputsuratkeluar.php"><button type="button" class="btn btn-primary btn-lg"><i class="fa fa-plus"></i> Tambah Surat Keluar</button></a>
                  </form>
                  <div class="x_content">
                  <div class="x_content">
                              <?php
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                            ...
                            while($data = mysqli_fetch_array($query1)){
                              ...
                              <a href=detail-suratkeluar.php?id_suratkeluar='.$data['id_suratkeluar'].'><button type="button" title="Detail" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></button></a>
